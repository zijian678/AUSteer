...
class Gemma2MLP(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.applied_module == 'ffn':
            ...
            # print('down_proj:',down_proj.shape,down_proj)
        return down_proj
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if self.applied_module == 'attention':
            # print('current processing attention steering:')
            # print('self.activation_mask:', self.activation_mask.shape, 'attn_output:', attn_output.shape)
...
class Gemma2Model(Gemma2PreTrainedModel):
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        # print('final hidden:',hidden_states)
